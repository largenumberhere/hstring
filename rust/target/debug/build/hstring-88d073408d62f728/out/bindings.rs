...
extern "C" {
    #[doc = " Add a single character to the heapstring, extending its length and moving the null terminator. Extends the capacity if neccesary\n Prefer using hstring_push_string or hstring_push_string_raw to minimize reallocations"]
    pub fn hstring_push_char(hstring: *mut HSTRING, item: ::std::os::raw::c_char);
}
extern "C" {
    #[doc = " Push a null terminated string. Use hstring_push_string_raw if your string may not be null terminated!"]
...
extern "C" {
    #[doc = "  Check the struct for any flaws and exit if any are found to prevent memory corruption. Very useful for debugging!"]
...
extern "C" {
    pub fn hstring_debug(hstring: *mut HSTRING);
}
extern "C" {
    pub fn hstring_realloc(hstring: *mut HSTRING);
}
extern "C" {
    pub fn nearest_power_of_2(number: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
pub const BUFFSIZE: usize = 128;
extern "C" {
    pub fn exit_with_stacktrace();
}
extern "C" {
    pub fn atoi_e_test();
}
