...
test:
	...
	ASAN_SYMBOLIZER_PATH="/usr/lib/llvm-14/llvm-symbolizer" clang -std=c11 -gdwarf-4 -ggdb3 -Wall -Werror -Wextra -Wno-gnu-folding-constant -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -Wshadow -o testing testing.c -fsanitize=address -g -fno-omit-frame-pointer -Lhstring hstring.c
